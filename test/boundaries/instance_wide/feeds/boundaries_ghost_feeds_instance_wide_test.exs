defmodule Bonfire.Federate.ActivityPub.BoundariesFeedsTest do
  ...
  test "does not create a Post for an incoming Note with ghosted instance" do
  ...
  test "does not create a Post for an incoming Note with ghosted actor" do
  ...
  test "hides a Post in feed from a remote instance that was ghosted later" do
